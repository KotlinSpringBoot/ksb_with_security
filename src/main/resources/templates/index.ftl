                                        ...
                                        <div className="feature-item-des">
                                            ...
                                            <ul>
                                                ...
                                                <li><strong>一键运行</strong>
                                                    Stand-alone Spring applications: Embed Tomcat, Jetty or Undertow
                                                    directly
                                                </li>
                                                <li><strong>自动管理依赖库</strong>'starter' POMs</li>
                                                <li><strong>自动化运维监控</strong>metrics, health checks and externalized
                                                    configuration
                                                </li>
                                                <li><strong>ZERO XML configuration</strong>Absolutely no code generation
                            ...
                            <li className="feature-item">
                                <div className="feature-item-feature">
                                    <div className="feature-item-text">
                                        ...
                                        <div className="feature-item-des">A JavaScript library for building user
                                            interfaces
                                            <ul>
                                                <li><strong>Declarative:</strong> React will efficiently update and
                                                    render just the right
                                                    components when your data changes.
                                                </li>
                                                <li><strong>Component-Based:</strong>Build encapsulated components that
                                                    manage their own state,
                                                    then compose them to make complex UIs.
                                                </li>
                                                <li><strong>Learn Once, Write Anywhere:</strong>React can also render on
                                                    the server using Node and
                            ...
                            <li className="feature-item">
                                <div className="feature-item-feature">
                                    <div className="feature-item-text">
                                        ...
                                        <div className="feature-item-des">Node.js® is a JavaScript runtime built on
                                            Chrome's V8 JavaScript
                                            engine.
                                            <ul>
                                                <li><strong>Event-driven, non-blocking I/O: </strong>lightweight and
                                                    efficient
                                                </li>
                                                <li><strong>NPM:</strong>Node.js' package ecosystem, npm, is the largest
